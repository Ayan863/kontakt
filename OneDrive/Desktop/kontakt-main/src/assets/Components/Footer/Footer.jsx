...
const Footer = () => {
  return (
   <footer className='w-full  pt-5 bg-white flex flex-col'>
      <div className="footerTop px-6 flex flex-col md:flex-row justify-between gap-8">
      ...
      <div className="footerSubscribe flex justify-center mt-6 ">
